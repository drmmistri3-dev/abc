...
const Sidebar: React.FC<SidebarProps> = ({ activeView, onNavigate, schoolName, t, onLogout }) => {
    ...
    <div className="flex flex-col h-full">
      <div className="p-6">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-black text-slate-800 tracking-tight leading-tight">{schoolName}</span>
        </div>
      </div>
